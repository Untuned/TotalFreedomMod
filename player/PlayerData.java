...
public class PlayerData implements ConfigLoadable, ConfigSavable, Validatable
{
    ...
    public long getFirstJoinUnix() {
        return this.firstJoinUnix;
    }
    
    public void setFirstJoinUnix(final long firstJoinUnix) {
        this.firstJoinUnix = firstJoinUnix;
    }
    
    public long getLastJoinUnix() {
        return this.lastJoinUnix;
    }
    
    public void setLastJoinUnix(final long lastJoinUnix) {
